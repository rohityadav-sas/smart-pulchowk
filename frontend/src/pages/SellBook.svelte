<script lang="ts">
    ...
    function hasValidContactInfo(): boolean {
        switch (primaryContactMethod) {
            case 'whatsapp': return !!whatsappNumber;
            case 'facebook_messenger': return !!facebookMessenger;
            case 'telegram': return !!telegramUsername;
            case 'email': return !!contactEmail;
            case 'phone': return !!phoneNumber;
            case 'other': return !!otherContactDetails;
                                ...
                                <div class="space-y-4 pt-6 border-t border-slate-100">
                                    <div>
                                        <p class="text-sm font-bold text-slate-700 mb-3 ml-1">
                                            How can buyers reach you? <span class="text-rose-500">*</span>
                                        </p>
                                        <p class="text-xs text-slate-400 mb-4 ml-1">
                                            🔒 Contact info is only shared after you approve a buyer's request
                                        </p>
                                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                            <button
                                                ...
                                                {primaryContactMethod === 'whatsapp' ? 'border-green-500 bg-green-50' : 'border-slate-100 hover:border-slate-200'}"
                                            >
                                                <svg class="w-7 h-7 {primaryContactMethod === 'whatsapp' ? 'text-green-600' : 'text-slate-400'}" viewBox="0 0 24 24" fill="currentColor">
                                                ...
                                                <span class="text-xs font-bold {primaryContactMethod === 'whatsapp' ? 'text-green-700' : 'text-slate-600'}">WhatsApp</span>
                                            </button>

                                            <button
                                                type="button"
                                                onclick={() => (primaryContactMethod = 'facebook_messenger')}
                                                class="p-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-2 group
                                                {primaryContactMethod === 'facebook_messenger' ? 'border-blue-500 bg-blue-50' : 'border-slate-100 hover:border-slate-200'}"
                                            >
                                                <svg class="w-7 h-7 {primaryContactMethod === 'facebook_messenger' ? 'text-blue-600' : 'text-slate-400'}" viewBox="0 0 24 24" fill="currentColor">
                                                ...
                                                <span class="text-xs font-bold {primaryContactMethod === 'facebook_messenger' ? 'text-blue-700' : 'text-slate-600'}">Messenger</span>
                                            </button>
                                            ...
                                            <button
                                                ...
                                                class="p-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-2 group
                                                {primaryContactMethod === 'telegram' ? 'border-sky-500 bg-sky-50' : 'border-slate-100 hover:border-slate-200'}"
                                            >
                                                <svg class="w-7 h-7 {primaryContactMethod === 'telegram' ? 'text-sky-600' : 'text-slate-400'}" viewBox="0 0 24 24" fill="currentColor">
                                                    <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/>
                                                </svg>
                                                <span class="text-xs font-bold {primaryContactMethod === 'telegram' ? 'text-sky-700' : 'text-slate-600'}">Telegram</span>
                                            </button>
                                            ...
                                            <button
                                                ...
                                                class="p-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-2 group
                                                {primaryContactMethod === 'email' ? 'border-purple-500 bg-purple-50' : 'border-slate-100 hover:border-slate-200'}"
                                            >
                                                <svg class="w-7 h-7 {primaryContactMethod === 'email' ? 'text-purple-600' : 'text-slate-400'}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                                </svg>
                                                <span class="text-xs font-bold {primaryContactMethod === 'email' ? 'text-purple-700' : 'text-slate-600'}">Email</span>
                                            </button>
                                            ...
                                            <button
                                                ...
                                                class="p-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-2 group
                                                {primaryContactMethod === 'phone' ? 'border-emerald-500 bg-emerald-50' : 'border-slate-100 hover:border-slate-200'}"
                                            >
                                                <svg class="w-7 h-7 {primaryContactMethod === 'phone' ? 'text-emerald-600' : 'text-slate-400'}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                                                </svg>
                                                <span class="text-xs font-bold {primaryContactMethod === 'phone' ? 'text-emerald-700' : 'text-slate-600'}">Phone</span>
                                            </button>
                                            ...
                                            <button
                                                ...
                                                class="p-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-2 group
                                                {primaryContactMethod === 'other' ? 'border-orange-500 bg-orange-50' : 'border-slate-100 hover:border-slate-200'}"
                                            >
                                                <svg class="w-7 h-7 {primaryContactMethod === 'other' ? 'text-orange-600' : 'text-slate-400'}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/>
                                                </svg>
                                                <span class="text-xs font-bold {primaryContactMethod === 'other' ? 'text-orange-700' : 'text-slate-600'}">Other</span>
                                            </button>
                                        </div>
                                    </div>
