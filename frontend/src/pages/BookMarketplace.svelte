  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="relative z-30 mb-8">
      ...
      <div class="max-w-4xl mx-auto space-y-4">
        ...
        <!-- Active Filter Tags -->
        {#if activeFiltersCount > 0}
          <div class="flex flex-wrap items-center gap-2 px-4" transition:fade>
            <span
            ...
            <div class="flex items-center gap-8">
              <div class="flex items-center gap-2">
                ...
                >
                  ...
                  <option value="oldest">Early Listings</option>
    ...
    {:else if !listingsQuery.data || listingsQuery.data.listings.length === 0}
      ...
      >
        ...
        <p class="text-slate-500 mb-10 font-medium leading-relaxed px-6">
          Be the first to list a book for sale in your campus community!
        </p>
        <button
          onclick={clearFilters}
          class="px-10 py-5 bg-blue-600 text-white font-black rounded-4xl hover:bg-blue-700 transition-all shadow-2xl shadow-blue-200"
        >
          All Books
        </button>
      </div>
      ...
      {#if listingsQuery.data.pagination.totalPages > 1}
        <div class="flex items-center justify-center gap-2 mt-10">
          ...
          <span class="px-4 py-2 text-gray-600">
            Page {currentPage} of {listingsQuery.data.pagination.totalPages}
          </span>
          <button
            onclick={() =>
            ...
            disabled={currentPage === listingsQuery.data.pagination.totalPages}
            class="px-4 py-2 border border-gray-200 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            Next
          </button>
